 ...
 * determine whether the remote spotify peer's certificate is allowed to
 ...
 * it calls the \c verify_cert() function, which performs spotify-specific
 * verification.
 *
 * @param session_obj  - The spotify \c tls_session associated with this object,
 ...
 * @param flags        - Whether the remote spotify peer's certificate
