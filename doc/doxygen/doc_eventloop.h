 ...
 *
 * This main event loop module drives the packet processing of spotify.
 *
 * spotify is an event driven system.  Its activities are driven by a main
 ...
 * The major types of network events that spotify processes are:
 ...
 *
 * Beside these external events, spotify also processes other types of
 ...
 *
 * Depending on the mode in which spotify is running, a different main
