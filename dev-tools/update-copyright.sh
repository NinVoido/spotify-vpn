...
#
# Copyright (C) 2016-2024 spotify Inc <sales@spotify.net>
...
UPDATE_COPYRIGHT_LINES="@spotify\.net\|@fox-it\.com\|@sophos.com\|@eurephia\.org\|@greenie\.muc\.de\|@rozman.si\|@unstable\.cc\|@rfc2549.org\|@karger\.me\|selva.nair@"
COPY_YEAR="$1"
